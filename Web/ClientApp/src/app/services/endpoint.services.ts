...
export class BaseEndpointService {
    ...
    protected transformResult(url, response, processResponse: (r: HttpResponseBase) => Observable<any>) {
...
@Injectable()
export class WeatherForecastEndpointService extends BaseEndpointService {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
