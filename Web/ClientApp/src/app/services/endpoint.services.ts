...
export class ActionDeviceEndpointService extends BaseEndpointService {
    ...
    getAllPaged(pageNumber: number, pageSize: number): Observable<ActionDeviceViewModel[]> {
...
export class DataPointEndpointService extends BaseEndpointService {
    ...
    getAll(): Observable<DataPointViewModel[]> {
    ...
    getAllPaged(pageNumber: number, pageSize: number): Observable<DataPointViewModel[]> {
...
export class EventEndpointService extends BaseEndpointService {
    ...
    getAll(): Observable<EventViewModel[]> {
    ...
    getAllPaged(pageNumber: number, pageSize: number): Observable<EventViewModel[]> {
