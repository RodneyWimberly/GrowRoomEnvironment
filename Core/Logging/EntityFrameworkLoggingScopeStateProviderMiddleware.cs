...
{
    public class EntityFrameworkLoggingScopeStateProviderMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly ILogger<EntityFrameworkLoggingScopeStateProviderMiddleware> _logger;

        public EntityFrameworkLoggingScopeStateProviderMiddleware(RequestDelegate next, ILogger<EntityFrameworkLoggingScopeStateProviderMiddleware> logger)
        {
            _next = next;
            _logger = logger;
        }
